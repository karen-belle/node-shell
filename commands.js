...
module.exports = {
    ...
    wc: function(done, array) {
        ...
        fs.readFile(array[0], function(err, data) {
            ...
            var output = array[0] + " has " + lines.length + " lines.";
